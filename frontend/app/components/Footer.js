          ...
          <ul className="Footer_nav__2rFid text-sm font-medium  sm:pb-20 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-10">
            <li className="space-y-5 row-span-2">
              ...
              <ul className="space-y-4 text-md">
                <li>
                  <a
                    className="hover:text-gray-200 text-white transition-colors duration-200 text-2xl"
                    href="/"
                  >
                    Jobs
                  </a>
            ...
            <li className="space-y-5 row-span-2">
              ...
              <ul className="space-y-4">
                <li>
                  <a
                    className="hover:text-white text-white transition-colors duration-200 text-2xl"
                    href="/"
                  >
                    News
                  </a>
            ...
            <li className="space-y-5">
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <a
                    className="hover:text-gray-200 text-white transition-colors duration-200 font-semibold text-2xl"
                    href="/"
                  >
                    Instagram
                  </a>
